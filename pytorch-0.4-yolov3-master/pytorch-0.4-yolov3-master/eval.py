...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', '-d',    type=str, 
        default='cfg/coco.data', help='data definition file')
    parser.add_argument('--config', '-c',  type=str, 
        default='cfg/yolov3-tiny.cfg', help='network configuration file')
    parser.add_argument('--weights', '-w', type=str, nargs='+',
        default=['weights/test63.weights'], help='initial weights file')
