...
def test_all(epoch, cfgfile):
    ...
    data_options  = read_data_cfg('cfg/coco.data')
    net_options   = parse_cfg(cfgfile)[0]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', '-d',
        type=str, default='cfg/flickrlogos.data', help='data definition file')
    parser.add_argument('--config', '-c',
        type=str, default='cfg/yolov3.cfg', help='network configuration file')
